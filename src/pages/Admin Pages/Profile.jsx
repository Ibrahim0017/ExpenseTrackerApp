...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://expense-tracker-ruug.onrender.com/api/organisation/update", formData, {
        headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-4 md:p-8 rounded-lg shadow-md">
      ...
      <form className="grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={handleSubmit}>
        ...
        <div className="col-span-1 sm:col-span-2">
          <button type="submit" className="bg-blue-600 text-white w-full md:w-auto px-4 py-2 mt-4 rounded-lg hover:bg-blue-700 transition-colors" disabled={isLoading}>
